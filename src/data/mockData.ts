...
export const mockRecipients: Recipient[] = [
  ...
  },
  {
    ...
    email: 'environment@nairobi.go.ke',
  },
  {
    id: '10',
...
export const mockLearningModules: LearningModule[] = [
  ...
  },
  {
    ...
    description: 'Discover sustainable business opportunities and how to launch a green startup.',
    duration: '25 min',
    points: 45,
    category: 'Skills',
    completed: false,
  ...
  },
  {
    ...
    description: 'Learn how communities can adapt to climate change impacts in Kenya.',
    duration: '20 min',
    points: 40,
    category: 'Knowledge',
    completed: false,
  ...
  {
    id: '9',
    title: 'Global Climate Movements',
    description: 'Join international youth climate action and understand global negotiations.',
    duration: '28 min',
    points: 50,
    category: 'Leadership',
    completed: false,
  ...
  {
    id: '10',
    title: 'Water Conservation & Rights',
    description: 'Understand Kenya\'s water crisis and how to advocate for water access.',
    duration: '22 min',
    points: 40,
    category: 'Knowledge',
    completed: false,
  ...
  },
  {
    ...
    description: 'Master the 5 Rs and organize community clean-up campaigns.',
    duration: '20 min',
    points: 40,
    category: 'Skills',
    completed: false,
  ...
  },
  {
    ...
    description: 'Explore Kenya\'s clean energy potential and advocate for energy access.',
    duration: '25 min',
    points: 45,
    category: 'Knowledge',
    completed: false,
