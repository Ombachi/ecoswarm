...
import {
  Leaf, Users, MessageCircle, Globe, ArrowRight, Heart, TreePine, Megaphone,
  BookOpen, Shield, Mail, ChevronDown, Target, Eye, Sparkles, ShoppingBag, Zap,
  ExternalLink, X, Award,
} from 'lucide-react';
...
const features = [
  { icon: MessageCircle, title: 'Agora Square', desc: 'Share your stories, ideas, and experiences with a community that cares.', color: 'from-primary to-secondary' },
  { icon: ShoppingBag, title: 'EcoMarket', desc: 'Discover and list eco-friendly products and services from local organizations.', color: 'from-secondary to-[hsl(var(--eco-blue))]' },
  { icon: Mail, title: 'EcoLetter Forge', desc: 'Generate powerful advocacy letters to decision-makers.', color: 'from-[hsl(var(--eco-gold))] to-[hsl(var(--eco-orange))]' },
  { icon: Sparkles, title: 'Capacity Hub', desc: 'Learn, grow, and earn points while building your activism skills.', color: 'from-[hsl(var(--eco-orange))] to-destructive' },
];
...
const globalStats = [
  { value: '59%', label: 'of youth very or extremely worried about climate change', icon: '😰', color: 'from-destructive/80 to-destructive' },
  { value: '83%', label: 'believe adults have failed to care for the planet', icon: '💔', color: 'from-[hsl(var(--eco-orange))] to-destructive' },
  { value: '45%', label: 'say climate anxiety negatively affects their daily functioning', icon: '🧠', color: 'from-secondary to-primary' },
  { value: '2.35%', label: 'of the global population experiences clinical-level eco-distress', icon: '🏥', color: 'from-primary to-secondary' },
  { value: '15.4%', label: 'face persistent subclinical climate distress', icon: '😔', color: 'from-[hsl(var(--eco-gold))] to-[hsl(var(--eco-orange))]' },
];

const kenyaStats = [
  { value: '36.1%', label: 'of consumers familiar with green/sustainable products', icon: '🇰🇪', color: 'from-primary to-secondary' },
  { value: '53.7%', label: 'had never even heard of sustainable products', icon: '❓', color: 'from-destructive/80 to-[hsl(var(--eco-orange))]' },
  { value: '39.5%', label: 'cited unavailability as a major barrier to buying green', icon: '🚫', color: 'from-secondary to-[hsl(var(--eco-blue))]' },
  { value: '1–3%', label: 'green products\' share of overall market — despite 70% willingness to buy', icon: '📉', color: 'from-[hsl(var(--eco-gold))] to-primary' },
];
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-background/80 backdrop-blur-lg border-b border-border/50">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" onClick={() => navigate('/role-select')} className="eco-gradient-bg text-primary-foreground border-0">Get Started</Button>
          </div>
        </div>
      </nav>
      ...
      <section id="hero" className="relative min-h-screen flex items-center pt-16">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 py-20 md:py-32 w-full">
          <motion.div initial="hidden" animate="visible" className="max-w-2xl">
            <motion.h1 custom={1} variants={fadeUp} className="text-4xl sm:text-5xl md:text-6xl font-black leading-tight tracking-tight mb-6">
        ...
        <button onClick={() => scrollTo('about')} className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 animate-bounce text-muted-foreground">
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {values.map((value, i) => (
              <motion.div key={value.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="eco-card-elevated p-6 text-center">
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {globalStats.map((s, i) => <StatCard key={s.value} stat={s} index={i} />)}
            </div>
          </div>
